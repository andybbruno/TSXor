...
#include <iostream>
#include <numeric>
#include "algo/DecompressorGorilla.cpp"
#include "algo/CompressorGorilla.cpp"
...
int main(int argc, char *argv[])
{
    ...
    CompressorGorilla c(times[0], values[0]);
    ...
    DecompressorGorilla dm(c.bs_times, c.bs_values, ncols);
